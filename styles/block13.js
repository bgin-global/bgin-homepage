...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function initTabSwitching() {
    const tabs = document.querySelectorAll('.block13-tab');
    const tabContents = document.querySelectorAll('.block13-tab-content');
    ...
    if (!document.querySelector('.block13-tab.active')) {
      const firstTab = document.querySelector('.block13-tab');
      if (firstTab) {
        firstTab.click();
      }
    }
  ...
  function initViewToggle() {
    ...
    function switchView(viewType) {
      ...
      document.querySelectorAll('.block13-toggle').forEach(toggle => {
  ...
  function initAccordion() {
    const accordions = document.querySelectorAll('.block13-accordion');
    
    accordions.forEach(accordion => {
      const header = accordion.querySelector('.block13-accordion-header');
      const content = accordion.querySelector('.block13-accordion-content');
      const icon = accordion.querySelector('.block13-accordion-icon');
  ...
  function initScrollAnimations() {
    ...
    const elementsToAnimate = document.querySelectorAll(`
      .block13-card,
      .project-card,
      .block13-publication-card,
      .block13-session-card,
      .block13-sponsor-card,
      .block13-section
    `);

...
export default function Block15AnnouncementPage() {
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-8">
            ...
            <h1 className={`${CUSTOM_STYLES.TITLE.CENTER} text-black mb-4`}>
              BGIN Announces Block #15 Conference in Washington, D.C.
            </h1>
            <p className="text-gray-600 text-sm mb-4">
              May 27, 2026, Blockchain Governance Initiative Network (BGIN)
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-xl text-gray-700 leading-relaxed mb-8">
              <strong>May 27, 2026</strong> - The Blockchain Governance Initiative Network (BGIN) is pleased to announce the 15th general meeting, <strong>Block #15</strong>, to be held in <strong>Washington, D.C.</strong> from <strong>October 15-16, 2026</strong>.
            </p>
            ...
            <p className={`${CUSTOM_STYLES.DESCRIPTION} text-gray-700 mb-6`}>
              Building on BGIN&apos;s mission established following the 2019 G20 Osaka Communiquﾃｩ, Block #15 continues our work as a Category A Liaison to ISO TC307. This unique permissionless forum brings together diverse stakeholders from regulators to cypherpunks to collaborate on critical blockchain governance standards.
            </p>
            ...
            <p className={`${CUSTOM_STYLES.DESCRIPTION} text-gray-700 mb-8`}>
              Registration details and the full program will be announced around late 2026. For more information about Block #15 and to stay updated on registration, please visit our <a href="/events/20261015-block15" className="text-blue-600 hover:underline">events page</a> or contact the BGIN Secretariat.
            </p>

      ...
      <article className="max-w-4xl mx-auto px-4 py-16">
        ...
        <header className="mb-8">
          ...
          <div className="flex items-center gap-4 text-gray-600 mb-6">
            <time dateTime="2026-08-25">September 8, 2026</time>
        ...
        <div className="text-gray-900">
          <p className="text-xl text-gray-700 mb-6 leading-relaxed">
            BGIN invites all interested participants to join our upcoming FASE, and IKP Working Group call this week on September 9, and 10.
            Whether you are a technologist, policymaker, researcher, or practitioner, your perspective is valuable. Come contribute to the development of open governance standards for blockchain ecosystems.
          </p>
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
              ...
              <ul className="space-y-3 text-gray-700">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <span className="font-semibold">Date:</span> Wednesday, September 9, 2026
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <span className="font-semibold">Time / Link:</span> 11:00 - 12:00 UTC{" "}
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
              ...
              <ul className="space-y-3 text-gray-700">
                <li className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <span className="font-semibold">Date:</span> Thursday, September 10, 2026
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <span className="font-semibold">Time / Link:</span> 12:00 - 13:00 UTC{" "}
                    <span className="text-gray-500 italic">To be shared via mailing list</span>
                  </div>
                </li>
              </ul>
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 my-6">
            <p className="text-gray-600">
              The sessions will focus on ongoing tracking of Working Group progress, key updates on blockchain governance standards, and open floor discussions for collaborative inputs. Additionally, as BGIN are working towards GDC and Block 15, the IKP WG will be discussing their projects, contributions and agendas for the upcoming event in October.
            </p>
          </div>

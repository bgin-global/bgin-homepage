...
export default function Block15RegistrationOpenPage() {
  return (
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 text-sm mb-2">
              August 4, 2026 · Blockchain Governance Initiative Network (BGIN)
            </p>
      ...
      <div className="py-12">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="text-xl text-gray-700 leading-relaxed mb-8">
            <strong>August 4, 2026</strong> — Registration is now open for{" "}
            <strong>{BLOCK15_META.title}</strong>, BGIN&apos;s 15th general
            meeting, in <strong>{BLOCK15_META.where}</strong> on{" "}
            <strong>October 15–16, 2026</strong>. The meeting is hybrid; remote
            participants will receive connection details after registering.
          </p>
          ...
          <p className={`${CUSTOM_STYLES.DESCRIPTION} text-gray-700 mb-6`}>
            {BLOCK15_META.why} Themes are confirmed; detailed session titles
            will be published as agendas firm up. Early registration helps us
            plan rooms, remote capacity, and contributor fee waivers.
          </p>
          ...
          <h2 className={`${CUSTOM_STYLES.SUBTITLE} text-black mt-12 mb-4`}>
            Priority project hubs
          </h2>
          <p className={`${CUSTOM_STYLES.DESCRIPTION} text-gray-700 mb-4`}>
            Use a project hub for status and documents, then register for the
            meeting:
          </p>
          ...
          <h2 className={`${CUSTOM_STYLES.SUBTITLE} text-black mt-12 mb-4`}>
            Fee waiver for contributors
          </h2>
          <p className={`${CUSTOM_STYLES.DESCRIPTION} text-gray-700 mb-6`}>
            Contributors who submit written contributions and present at Block
            15 may receive a complete registration fee waiver. Details are on
            the{" "}
            <Link
              href={`${BLOCK15_PAGE}#contributions`}
              className="text-blue-700 underline"
            >
              Block 15 contributions section
            </Link>
            .
          </p>

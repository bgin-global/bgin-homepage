    ...
    <main className="block13-page min-h-screen bg-white w-screen">
      ...
      <nav className="sticky top-0 z-30 bg-gray-100 border-b border-gray-200 py-3 px-4 shadow-sm" aria-label="セクションへジャンプ">
        <div className="max-w-6xl mx-auto flex flex-wrap items-center justify-center gap-2 sm:gap-3">
          ...
          <Link href="/events/20260301-block14" className="text-sm font-medium text-gray-700 hover:text-blue-600 px-3 py-1.5 rounded-md hover:bg-white transition-colors ml-auto">English</Link>
        </div>
      </nav>

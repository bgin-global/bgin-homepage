...
export default function ItemBlock({
  ...
  return (
    <div
      className="bg-white h-full w-auto flex-1 flex-col flex justify-between items-start gap-4 pt-4 pb-6 px-1 rounded-md bgin-button border border-gray-200 border-l-4"
      style={identity ? { borderLeftColor: identity.hex } : undefined}
    >
      <div className="w-full">
        {withImage && (
          <div className="bg-cover w-full h-[200px] gap-2.5 rounded-md" />
        )}

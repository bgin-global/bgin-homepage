...
const RoomImageCarousel = ({ images, roomName }: RoomImageCarouselProps) => {
  ...
  // Convert to array if single string, handle null
  const imageArray = !images ? [] : (typeof images === 'string' ? [images] : images);
  ...
  if (!imageArray.length) {
    ...
    return (
      <div className="relative w-full h-full min-h-[192px] md:min-h-[300px] bg-gray-200 rounded-lg flex items-center justify-center">

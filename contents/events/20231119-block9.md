...
|11:15 - 11:30|Coffee Break||
|11:30 - 11:45|Open Source Wallet Development|Daniel Goldschrier(Open Wallet Foundation)|
|11:45 - 12:15|Tokenised economy, Role of Wallet and Multi-Party Computation|Nat Sakimura<br>  Daniel Goldschrier|
|12:15 - 13:30|Lunch||
|13:30 - 15:00|Workshop Session (Room A) ZKP and its applications|Leo Hioki(Intmax)<br>  Masato Tsutsumi|
||Workshop Session (Room B) Accountable Wallet|Masato Yamanaka<br>  Daniel Goldschrier<br>  Mark Greenslade<br>  Mitchell Travers|
|15:00 - 15:30|Coffee Break||
...
||Workshop Session (Room B) Digital Identity - a global discourse|Nat Sakimura<br>  Stephan Wilson<br>  Stefano Tempest<br>  Hal Seki (Japan Digital Agency)<br>  Daniel Goldschrier|
...
|11:30 - 12:30|Blockchain for Trustworthiness of digital society|NTT Digital<br> Soulbis<br>NRI<br> Joi Ito (Digital Garage)|
|12:30 - 13:30|Lunch Break||
|13:30 - 14:00||Dr Dimitrios Salampasis|
|14:00 - 14:45|Australian Blockchain Trend 1|Steve Vallas|
|14:45 - 15:00|Coffee Break||
|15:00 - 15:45|Australian Blockchain Trend 2|Hannah Glass|
|15:45 - 16:15|BGIN Roadmap and Business|Shin'ichiro Matsuo|
|17:00 - 18:00|Closing|Shin'ichiro Matsuo<br> Joseph Beverley|
...
<div class="speakers text-center gap-4">
    ...
    <div class="speaker">
        <img src="/images/Events/person/Zooko Wilcox-O'Hearn.jpg">
    ...
    <div class="speaker">
        <img src="/images/Events/person/Stefano Tempest.jpg">
        <h4>Stefano Tempest</h4>
        <h4>Blockchain Committee Vice Chair, Australian Computer Society </h4>
    </div>
    <div class="speaker">
        <img src="/images/Events/person/Stephen Wilson.jpg">
    ...
    <div class="speaker">
        <img src="/images/Events/person/Alejandro Gutierrez.jpg">
        <h4>Alejandro Gutierrez</h4>
        <h4>CEO - Founder, DeFactor</h4>
    </div> 
    <div class="speaker">
        <img src="/images/Events/person/Paul Travers.jpg">
        <h4>Paul Travers</h4>
    ...
    <div class="speaker">
        <!--img src="/images/Events/person/Dimitrios_Salampasis,.jpg"-->
        <h4>Mehdi Zerouali</h4>
        <h4>Director at Sigma Prime</h4>
    </div>
    <div class="speaker">
        <!--img src="/images/Events/person/Dimitrios_Salampasis,.jpg"-->
        <h4>Simon Callaghan</h4>
        <h4>CEO & Board Director at Blockchain Australia</h4>
    </div>
    <div class="speaker">
        <!--img src="/images/Events/person/Dimitrios_Salampasis,.jpg"-->
        <h4>Steve Vallas</h4>
        <h4>Managing Director at Blockchain APAC</h4>
    </div>
    <div class="speaker">
        <!--img src="/images/Events/person/Dimitrios_Salampasis,.jpg"-->
        <h4>Dr. Mark Staples</h4>
        <h4>CTO at DFCRC; Senior Principal Researcher at CSIRO, Data 61</h4>
    </div>
    <div class="speaker">
        <!--img src="/images/Events/person/Dimitrios_Salampasis,.jpg"-->
        <h4>Daniel Goldscheider</h4>
        <h4>Founder & Executive Director of OpenWallet</h4>
    </div>
    <div class="speaker">
        <!--img src="/images/Events/person/Dimitrios_Salampasis,.jpg"-->
        <h4>Mark Greenslade</h4>
        <h4>Head of Research & Development at Casper Network</h4>
    </div>
    <div class="speaker">
        <!--img src="/images/Events/person/Dimitrios_Salampasis,.jpg"-->
        <h4>Leon Molchanovsky</h4>
        <h4>CEO of Galaxy; Steer Co. Member at BGIN</h4>
    </div>
    <div class="speaker">
        <!--img src="/images/Events/person/Dimitrios_Salampasis,.jpg"-->
        <h4>Katya Delak</h4>
        <h4>Program Coordinator at NIST</h4>
    </div>
    <div class="speaker">
        <!--img src="/images/Events/person/Dimitrios_Salampasis,.jpg"-->
        <h4>Alec Christie</h4>
        <h4>Partner at Clyde & Co.</h4>
    </div>
    <div class="speaker">
        <!--img src="/images/Events/person/Dimitrios_Salampasis,.jpg"-->
        <h4>Iris Rad</h4>
        <h4>Associate, Technology & Media at Clyde & Co.</h4>
    </div>
</div>

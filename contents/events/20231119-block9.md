...
|10:30 - 11:15|The Harmonisation of CBDC, Deposit Token, Stablecoin, Crypto Assets and DeFi<br>& Include the Circle Rep: Lulio Vargas-Cohen (if he is the confirmed main discussant)|**Moderator**<br>Stephanie Bazley (Possible Ventures)<br><br>**Main Discussants**<br>James Angel (Georgetown University)<br>Masaki Bessho (Bank of Japan)<br>Paul Travers (KPMG Risk and Treasury)<br>Alejandro Gutierrez (DeFactor)<br>+CIRCLE|
...
||Workshop(Room B): Transparency of dApps and Sound DeFi|Ryosuke Ushida (JFSA)<br>Mark Greenslade (Head of R&D @ Casper Association)<br>Jemma Xu (Portal Gate)|
...
<div class="speakers text-center gap-4">
    ...
    <div class="speaker">
        ...
        <h4>Rob Allen</h4>
        <h4>Head of Web3 and Future Payments Systems, Australian Payments Plus</h4>
    </div>
    <div class="speaker">
